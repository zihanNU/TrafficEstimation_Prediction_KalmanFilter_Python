...
##    for vm in range(119,120):
##        for rhom in range(188,190):
##            for rhoc in range(48,50):
##                para=[vm,rhom,rhoc]
##                hood=get_likelihood(para)[0][0]
##                likelihood.append(hood)
##                file_hood.write(str(hood)+'\n')
    para0=[92, 175, 38]
    print para0
